  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div id="collapse" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading">
        <table class="panel-body table table-condensed">
          <tbody>
            ...
            <?php $results = $db->query('SELECT * FROM events ORDER BY uts'); ?>
            ...
            <tr>
              ...
              <td class="text-right" style="padding-right: 15px;">
                <button id="<?php echo $row['id']; ?>" class="close event-remove" style="float: none;">&times;</button>
              </td>
            </tr>
            <?php endwhile; ?>
          </tbody>
      ...
      <div class="panel-footer" role="tab" id="footer" data-toggle="collapse-disabled" href="#collapse" aria-expanded="true" aria-controls="collapse">
        Events<button class="close" data-toggle="modal" data-target="#modal">&plus;</button>
      </div>
    </div>
  </div>
</div>
